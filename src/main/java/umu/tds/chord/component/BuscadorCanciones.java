...
/**
 * Interfaz que deben implementar las clases que ofrecerán la funcionalidad
 * de carga de canciones.
 */
public interface BuscadorCanciones {
	 ...
	 * 
	 * @param fichero Fechero que describe las canciones que se deben cargar
	 * en memoria.
	 */
	public void setArchivoCanciones(String fichero);
	
	/**
	 * Método que añade un listener para escuchar los eventos de carga de
	 * canciones.
	 * 
