...
public interface DAO<T extends Persistent> {
	...
	/**
	 * Dada una lista de objetos persistentes obtiene una cadena de texto con las
	...
	/**
	 * Registra un nuevo objeto persistente y establece la id persistente del objeto
	 * proporcionado.
	 *
	...
	/**
	 * Obtiene una lista de objetos persistentes a partir de una cadena de texto que
