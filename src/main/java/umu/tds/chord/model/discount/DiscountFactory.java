...
public class DiscountFactory {
	...
	public static Discount createDiscount(Date start, Date end, Type t) {
		switch (t) {
		case NONE: return new Discount(start, end);
		case ELDER: return new ElderDiscount(start, end);
		case TEMPORARY: return new TemporaryDiscount(start, end);
		default:
	...
	/**
	 * Crea un nuevo descuento basandose en el tipo de descuento proporcionado.
	 * El descuento será nuevo completamente, de forma que si tiene una 
	 * caducidad de dos meses, caducará a los 2 meses de su cración mediante
	 * este método.
	 * 
	 * @param t Tipo de descuento que se desea crear.
	 * 
	...
	public static Discount createDiscount(Type t) {
		switch (t) {
		case NONE: return new Discount();
		case ELDER: return new ElderDiscount();
		case TEMPORARY: return new TemporaryDiscount();
		default:
			throw new IllegalArgumentException("Unexpected value: " + t);
		}
	}
