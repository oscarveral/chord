	...
	private void initializeFocusListener() {
		addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				if (empty)
					silentTextChange(null, Color.BLACK);
			}
		});
	}
	...
	private void initializeDocumentListener() {
		getDocument().addDocumentListener(new DocumentListener() {
			...
			public void removeUpdate(DocumentEvent e) {
				...
				Arrays.stream(((AbstractDocument) getDocument()).getDocumentListeners()).filter(l -> !l.equals(this))
						.forEach(l -> l.removeUpdate(e));
			}
